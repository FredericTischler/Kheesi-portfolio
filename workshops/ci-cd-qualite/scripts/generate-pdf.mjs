...
const filesToConvert = [
  "README.md",
  "slides/ci-cd-slides.md",
  "guides/animateur.md",
  "guides/participant.md",
  "exercices/01-linting-conventions.md",
  "exercices/02-testing-strategy.md",
  "exercices/03-pipeline-build-test.md",
  "exercices/04-quality-gates.md",
  "checklists/checklist-ci.md",
  "checklists/checklist-qualite.md"
];
